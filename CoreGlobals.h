...
extern CORE_API float meteor_posX;
extern CORE_API float meteor_posY;
extern CORE_API float meteor_posZ;
extern CORE_API float meteor2_posX;
extern CORE_API float meteor2_posY;
extern CORE_API float meteor2_posZ;
extern CORE_API float meteor3_posX;
extern CORE_API float meteor3_posY;
extern CORE_API float meteor3_posZ;
